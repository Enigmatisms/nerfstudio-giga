...
CUDA_VISIBLE_DEVICES=0 ns-train depth-nerfacto \
        --data ../dataset/DayaTemple_opt/transforms_opt.json \
        --load-dir ./outputs/DayaTemple/depth-nerfacto/DayaTemple${2}/nerfstudio_models/ \
        --timestamp DayaTemple${2} \
        ...
        --pipeline.model.original-image-num 83 \
        ...
        --pipeline.datamanager.transform_path ./outputs/$folder/depth-nerfacto/DayaTemple${2}/dataparser_transforms.json \

...
for idx in ${opt_ids[@]}; do
    ...
    CUDA_VISIBLE_DEVICES=0 ns-train depth-nerfacto \
        --data ../dataset/${folder}_opt/transforms_opt.json \
...
cd pose_viz/
python3 ./replace_pose.py -s theOldGate_opt -n theOldGate_1 -m "none" -o ../../dataset/ --scale 8.0
# python3 ./replace_pose.py -s HaiyanHall_opt -n HaiyanHall_colmap_high -m "colmap" -o ../../dataset/ --scale 4.0
cd ..
...
for idx in ${opt_ids[@]}; do
    ...
    python3 ./pose_viz/hloc_poser.py -i $output_path --merge -o "transforms_colmap.json" --outpath $output_path  --scale 2.0               # 保留原本的 transforms.json
...
python3 ./pose_viz/hloc_poser.py -i ${output_folder}theOldGate --transform --merge -o "transforms_colmap.json" --outpath ${output_folder}theOldGate/ --scale 2.0

...
#     --data ../dataset/HaiyanHall_IGEV/transforms.json \
#     --load-dir ./outputs/HaiyanHall_IGEV/depth-nerfacto/haiyanhall/nerfstudio_models/ \
...
# CUDA_VISIBLE_DEVICES=0 ns-train depth-nerfacto \
#     --data ../dataset/MemorialHall_IGEV/transforms.json \
#     --timestamp memo_hall \
#     --logging.local-writer.max-log-size 10 \
#     --pipeline.model.log2-hashmap-size 19 \
#     --pipeline.model.hidden-dim 64 \
...
# CUDA_VISIBLE_DEVICES=0 ns-train depth-nerfacto \
#     --data ../dataset/MemorialHall_IGEV/transforms.json \
#     --load-dir ./outputs/MemorialHall_IGEV/depth-nerfacto/memo_hall/nerfstudio_models/ \
#     --logging.local-writer.max-log-size 10 \
#     --pipeline.model.log2-hashmap-size 19 \
#     --pipeline.model.hidden-dim 64 \
...
# CUDA_VISIBLE_DEVICES=0 ns-train depth-nerfacto \
#     --data ../dataset/Museum_IGEV/transforms.json \
#     --timestamp mesuem \
#     --logging.local-writer.max-log-size 10 \
#     --pipeline.model.log2-hashmap-size 19 \
#     --pipeline.model.hidden-dim 64 \
...
# CUDA_VISIBLE_DEVICES=0 ns-train depth-nerfacto \
#     --data ../dataset/Museum_IGEV/transforms.json \
#     --load-dir ./outputs/Museum_IGEV/depth-nerfacto/mesuem/nerfstudio_models/ \
#     --logging.local-writer.max-log-size 10 \
#     --pipeline.model.log2-hashmap-size 19 \
#     --pipeline.model.hidden-dim 64 \
#     --pipeline.model.distortion-loss-mult 0.002 \
...
# CUDA_VISIBLE_DEVICES=0 ns-train depth-nerfacto \
#     --data ../dataset/Library_IGEV/transforms.json \
#     --timestamp library \
#     --logging.local-writer.max-log-size 10 \
#     --pipeline.model.log2-hashmap-size 19 \
#     --pipeline.model.hidden-dim 64 \
...
CUDA_VISIBLE_DEVICES=0 ns-train depth-nerfacto \
    --data ../dataset/Library_IGEV/transforms.json \
    --load-dir ./outputs/Library_IGEV/depth-nerfacto/library/nerfstudio_models/ \
    --logging.local-writer.max-log-size 10 \
    --pipeline.model.log2-hashmap-size 19 \
    --pipeline.model.hidden-dim 64 \
